...
usage() {
  this=$1
  cat <<EOF
$this: download go binaries for ojizero/gomakehelp

Usage: $this [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/ojizero/gomakehelp/releases
   If tag is missing, then the latest will be used.

 Modified from cosmteck/air
...
get_binaries() {
  case "$PLATFORM" in
    darwin/amd64) BINARIES="gomakehelp" ;;
